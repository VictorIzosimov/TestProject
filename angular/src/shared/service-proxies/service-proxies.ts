...
export class ContactsServiceProxy {
    ...
    getContactForEdit(id: number | undefined): Observable<GetContactForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Contact/GetContactForEdit?";
        if (id === null)
    ...
    get(id: number | undefined): Observable<ContactDto> {
        let url_ = this.baseUrl + "/api/services/app/Contacts/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ContactDtoPagedResultDto> {
     ...
     * @return Success
     */
    create(body: ContactDto | undefined): Observable<ContactDto> {
...
export class ContactListDtoListResultDto implements IContactListDtoListResultDto {
    items: ContactListDto[] | undefined;

    constructor(data?: IContactListDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ContactListDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ContactListDtoListResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ContactListDtoListResultDto {
        const json = this.toJSON();
        let result = new ContactListDtoListResultDto();
        result.init(json);
        return result;
...
export interface IContactListDtoListResultDto {
    items: ContactListDto[] | undefined;
}
//contacts
...
export class GetContactForEditOutput implements IGetContactForEditOutput {
    ...
    init(_data?: any) {
        if (_data) {
            this.contact = _data["contact"] ? ContactEditDto.fromJS(_data["contact"]) : <any>undefined;
        }
    }
